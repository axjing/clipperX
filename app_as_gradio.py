...
transcribe_config_path=os.path.join(CURRENT_DIR,"caches/transcribe_config.yaml")
...
demo=gr.Interface(
    ...
    inputs=[gr.Video(source="upload", label="In",type="filepath", format="",interactive=True),
